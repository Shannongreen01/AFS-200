...
def play():
    ...
    while continueGame:
        ...
        if result is True:
            ...
            currentAttempts -= 1
            print(f"That is not correct there is no letter {userGuess} in the word.")
            print(f"You have {currentAttempts} attempts remaining.")
        ...
        if ' _ ' not in wordBoard:
            continueGame = False
            print("Congradulations you have guessed the word and won the game!")
